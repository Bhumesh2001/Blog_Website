...
import womenStyle from "../assets/images/001.jpg"
import gallery1 from "../assets/images/023.jpg"
import gallery2 from "../assets/images/014.jpg"
import gallery3 from "../assets/images/033.jpg"
...
const PostFormatGallery = () => {
  ...
  return (
    <React.Fragment>
      <Layout5>
        {/* breadcrumb */}
        <BreadCrumb title="Post Format Gallery" titleType="Post" />
...
export const Head = () => <Seo title="Post Format Gallery" />
